...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <div class="container">
     <div class="card mb-2">
         <div class="row">
          <img src="{{ URL::to('/') }}/clinic.png}}" alt="" class="logo col-lg-2 col-md-3 col-sm-4 col-3">
          <h5 class="sub-heading col-md-8 col-sm-6 col-8"><b>Myat Saydana Family Health Care & Clinic</b></h5>
         </div>
 <div class="card-body">
 ...
 <h6 class="footer"><br>No.1607,Bagan Road,54-Wards,South Dagon Township, Yangon
        <br>Phone:09960863081,09976363263,09773998682<br>
    www.myatsaydanaclinic.com</h6>
        </div>
 </div>
 </div>
 </div>
